...
| ID | Decision | Reason |
|---|---|---|
| D-001 | Core product remains agent-independent; Codex is first adapter. | Universal product, MVP delivery. |
| D-002 | Evidence and deterministic checks drive evaluation. | Reproducible claims over subjective judgment. |
