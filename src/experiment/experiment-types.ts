...
export interface ConditionContextManifest { conditionId:ExperimentConditionId; contextKind:"original-repository"|"camarade-compiled"; contextPath:string; contextHash:string; sourcePaths:string[]; }
