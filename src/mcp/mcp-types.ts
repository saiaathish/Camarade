...
export const CAMARADE_MCP_SERVER_VERSION = "1.3.0";
...
export const RUN_FAIR_EXPERIMENT_TOOL_NAME = "camarade.run_fair_experiment";
export const MEASURE_EXPERIMENT_TOOL_NAME = "camarade.measure_experiment";
export const EXPLAIN_EXPERIMENT_TOOL_NAME = "camarade.explain_experiment";
